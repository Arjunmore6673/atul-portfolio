    ...
    <section id="contact" className="section-padding hero-gradient relative overflow-hidden">
      ...
      <div className="container-narrow relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Email Display */}
          <div className="mt-10 pt-10 border-t border-primary-foreground/10 animate-fade-up opacity-0" style={{ animationDelay: "0.5s" }}>
            <p className="text-sm text-primary-foreground/50 mb-2">Or reach out directly:</p>
            <a 
